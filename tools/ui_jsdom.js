...
report('after boot');
const st = {"tabs":[{"id":1,"url":"https://a.test/","title":"A","progress":100,"loading":false,"favicon":null}],"current":1,"url":"https://a.test/","progress":100,"loading":false,"desktop":true,"can_back":false,"can_forward":false,"bookmarks":{"bar":{"id":"bar","type":"folder","title":"Bookmarks bar","children":[{"id":"b1","type":"url","url":"https://a.test/","title":"A"},{"id":"b2","type":"folder","title":"Work","children":[{"id":"b3","type":"url","url":"https://w.test/","title":"W"}]}]},"other":{"id":"other","type":"folder","title":"Other bookmarks","children":[]}},"bookmarks_flat":[{"id":"b1","url":"https://a.test/","title":"A"},{"id":"b3","url":"https://w.test/","title":"W"}],"history":[{"url":"https://h.test/","title":"H","at":Math.floor(Date.now()/1000)}],"scripts":[{"id":"s1","name":"Hi","enabled":true,"type":"js","run_at":"end","match":["*"],"code":"console.log(1)"}],"blocks":["*ads*"],"billing":{"status":"ready","products":[{"id":"tip_small","title":"Coffee","description":"A small tip","price":"$1.99"}],"thanks":false},"bookmarks_bar":true,"settings":{"search":"google","home":"https://www.google.com/","desktop_ua":true,"bookmarks_bar":true,"force_dark":false,"text_zoom":100,"javascript":true,"cookies_3p":true,"dock_side":"right","devtools_theme":"dark","devtools_screencast":false},"version":{"app":"0.6.0","ruby":"4.0.0"},"devtools":{"open":false,"side":"right","fraction":0.45}};
...
try {
  ...
  click(doc.querySelector('[data-act="menu.toggle"]')); click(doc.querySelector('[data-act="page:scripts"]'));
  console.log('scripts page:', doc.getElementById('page').innerHTML.includes('Block requests') && doc.getElementById('page').innerHTML.includes('Hi'));
  click(doc.querySelector('[data-act="script.edit"]'));
  console.log('script editor:', doc.getElementById('page').innerHTML.includes('sc-code'));
  click(doc.querySelector('[data-act="script.save"]'));
  console.log('script save sent:', sent.some(e => e.ev === 'script.update' && e.attrs && e.attrs.code === 'console.log(1)'));
  click(doc.querySelector('[data-act="page:close"]'));
  click(doc.querySelector('[data-act="menu.toggle"]')); click(doc.querySelector('[data-act="page:support"]'));
  console.log('support page:', doc.getElementById('page').innerHTML.includes('$1.99') && sent.some(e => e.ev === 'support.open'));
