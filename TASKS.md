...
- [x] Store listing: icon + feature graphic (bin/make_store_art.rb), 6 framed screenshots (bin/frame_screenshots.rb), short/full description, privacy policy URL, content rating (Everyone/PEGI 3), data safety (none), target 18+, tags. **Published on Google Play 2026-09-10 08:57** (0.8.2 / 802, production, 176 countries + rest of world). 0.8.3 (803) + native debug symbols ready as first update.
